    ...
    return (
        <div className="rounded-lg overflow-hidden border border-white/10 shadow-2xl bg-[#1B1520]">
            ...
            <div className="p-5 md:p-6 font-mono text-[13px] leading-relaxed text-left overflow-x-auto">
                ...
                {line(1, <><span className="text-[#C99AE0]">'category'</span><span className="text-white/60">: </span><span className="text-[#9ED8A5]">'ERP / Odoo'</span><span className="text-white/60">,</span></>)}
                {line(1, <><span className="text-[#C99AE0]">'versions'</span><span className="text-white/60">: </span><span className="text-[#F0C674]">'v8 → v18'</span><span className="text-white/60">,</span></>)}
